  ...
  return (
    <div className="min-h-screen bg-white text-black">
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        <h1 className="text-3xl font-serif text-gray-900 mb-12">
          Your Selection
        </h1>
          ...
          <>
            ...
            <div className="mt-12 flex justify-end">
              <div className="w-full max-w-sm">
                ...
                <Link
                  href="/checkout"
                  className="block w-full bg-black text-white py-4 text-xs uppercase tracking-widest hover:bg-gray-800 transition text-center"
                >
                  Proceed to Checkout
                </Link>
              </div>
